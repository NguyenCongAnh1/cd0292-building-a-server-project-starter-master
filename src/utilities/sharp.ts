...
async function imageResizeMiddleware(req: express.Request, res: express.Response, next: express.NextFunction) {
    ...
    if (fs.existsSync(thumbImagePath) && await isSameSize(thumbImagePath, width, height)) {
